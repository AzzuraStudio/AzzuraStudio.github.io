...
const openai = new OpenAI({
  ...
  defaultHeaders: {
    'HTTP-Referer': 'https://azzurastudio.github.io/openai/', // Your site URL
    'X-Title': 'OpenAI Query', // Your site name
  },
});
...
document.getElementById('searchBtn').addEventListener('click', async () => {
  ...
  try {
    const completion = await openai.chat.completions.create({
      model: 'deepseek/deepseek-chat:free', // Ensure the model is correct
      messages: [
        {
          role: 'user',
          content: query,
